...
class StaticWebFieldWidget extends StatefulWidget {
  ...
  @override
  State<StaticWebFieldWidget> createState() => _StaticWebFieldWidgetState();
}

class _StaticWebFieldWidgetState extends State<StaticWebFieldWidget> {
