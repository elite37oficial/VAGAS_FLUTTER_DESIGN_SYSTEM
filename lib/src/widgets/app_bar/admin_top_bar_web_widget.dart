...
class AdminTopBarWebWidget extends StatefulWidget {
  final double height;
  final bool? isMobile;
  final String username;
  final Function usersFunction;
  ...
  @override
  State<AdminTopBarWebWidget> createState() => _AdminTopBarWebWidgetState();
}

class _AdminTopBarWebWidgetState extends State<AdminTopBarWebWidget> {
  OverlayEntry? entry;
